    ...
    static let defaultEnglish = KeyboardLayout(
        ...
        rows: [
            ...
            [
                ...
                KeyModel(id: "e", primaryLabel: "e", shiftLabel: "E", fontSize: nil, isAction: false, alternates: ["3", "é", "è", "ê", "ë"], widthMultiplier: 1.0),
                ...
                KeyModel(id: "u", primaryLabel: "u", shiftLabel: "U", fontSize: nil, isAction: false, alternates: ["7", "ú", "ü"], widthMultiplier: 1.0),
                KeyModel(id: "i", primaryLabel: "i", shiftLabel: "I", fontSize: nil, isAction: false, alternates: ["8", "í", "ï"], widthMultiplier: 1.0),
                KeyModel(id: "o", primaryLabel: "o", shiftLabel: "O", fontSize: nil, isAction: false, alternates: ["9", "ó", "ö", "ô"], widthMultiplier: 1.0),
                KeyModel(id: "p", primaryLabel: "p", shiftLabel: "P", fontSize: nil, isAction: false, alternates: ["0"], widthMultiplier: 1.0)
            ],
            // ROW 2
            [
                KeyModel(id: "a", primaryLabel: "a", shiftLabel: "A", fontSize: nil, isAction: false, alternates: ["á", "ä", "æ"], widthMultiplier: 1.0),
                KeyModel(id: "s", primaryLabel: "s", shiftLabel: "S", fontSize: nil, isAction: false, alternates: ["ß", "ś"], widthMultiplier: 1.0),
            ...
            [
                ...
                KeyModel(id: "z", primaryLabel: "z", shiftLabel: "Z", fontSize: nil, isAction: false, alternates: ["ž"], widthMultiplier: 1.0),
                KeyModel(id: "x", primaryLabel: "x", shiftLabel: "X", fontSize: nil, isAction: false, alternates: [], widthMultiplier: 1.0),
                KeyModel(id: "c", primaryLabel: "c", shiftLabel: "C", fontSize: nil, isAction: false, alternates: ["ç", "ć"], widthMultiplier: 1.0),
                ...
                KeyModel(id: "n", primaryLabel: "n", shiftLabel: "N", fontSize: nil, isAction: false, alternates: ["ñ", "ń"], widthMultiplier: 1.0),
